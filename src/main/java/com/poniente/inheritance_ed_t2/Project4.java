...
/**
 * Esta clase muestra la jerarquía de formas matemáticas que vamos a crear por herencia.
 * 
 * @author Pratik Patel
...
public class Project4 {
    ...
    public static void main(String args[]) {
        try {
            ...
            Triangle triangle_3 = new Triangle(triangle_2);  // invoca el constructor de copia
            ...
            r1.setWidth(3);
            r2.setHeight(10); /*establecer uso de altura */
            r3 = new Rectangle(r2);
            r3.setHeight(100);
            myShapes.add(r1);
            myShapes.add(r2);
            ...
            sphere_3 = new Sphere(sphere_1);  // invoca el constructor de copia
            ...
            cube_1 = new Cube(4);
            cube_2 = new Cube(12);
            cube_3 = new Cube(cube_1);  // invoca el constructor de copia
            ...
            cy3 = new Cylinder(cy2);   // invoca el constructor de copia
            cy3.setHeight(15);
            cy3.setRadius(10);
            myShapes.add(cy1);
            myShapes.add(cy2);
            ...
            cone_3 = new Cone(cone_1);  // invoca el constructor de copia
            cone_3.setHeight(15);
            cone_3.setRadius(10);
            myShapes.add(cone_1);
            myShapes.add(cone_2);
            ...
            for (Shape s : myShapes) {  // usando bucle for-each 
                // for (int ii = 0; ii < myShapes.size(); ii++) {
                out.println(s.getClass().getName());  //imprime el nombre de la clase que el objeto pertenece 
                s.print(out);             // al enlace dinámico
                out.println();
            }
            out.close();
        } // fin del try
